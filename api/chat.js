...
- App Gas (en produccion, piloto en Chillan): SaaS multi-empresa para distribuidoras de gas licuado. PostgreSQL/Supabase con aislamiento por empresa via RLS en 41 tablas, 52 migraciones versionadas y 217 pruebas pgTAP que corren en GitHub Actions y bloquean el merge. Frontend Next.js 16 / React 19 en Vercel. Decisiones de diseno: el stock nunca se escribe a mano, solo se mueve con asientos en un kardex append-only; la cuadratura diaria separa el faltante real del papeleo pendiente (guias de recepcion y comodatos sin registrar); la entrega del repartidor es una sola transaccion en la base —venta, vacios, comodato y cobro— porque entre una escritura y otra hay una red de camion. Tambien calcula que pedirle a la envasadora con teoria de inventarios, y muestra el rango y la confianza de esa estimacion en vez de un numero que haya que creer. No tiene enlace publico: opera con datos reales de clientes.
